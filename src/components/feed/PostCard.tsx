  ...
  return (
    ...
    >
      <div className="flex space-x-3">
        <Avatar
          className={detailed ? "w-11 h-11" : "w-10 h-10"}
          ...
          <div className={detailed ? "-ml-12 mt-3 md:mt-6" : ""}>
            ...
            <div
              className={cn(
                ...
                detailed
                  ? "max-w-lg border-t border-border mt-4 pt-4"
                  : "max-w-md"
              )}
            >
              <Button
                ...
                size="sm"
                onClick={(e) =>
                  handleInteractionClick(e, () => onComment(post.id))
                }
              ...
              <Button
                ...
                size="sm"
                onClick={(e) =>
                  handleInteractionClick(e, () => onRepost(post.id))
                }
                className={cn(
              ...
              <Button
                ...
                size="sm"
                onClick={(e) =>
                  handleInteractionClick(e, () => onLike(post.id))
                }
                className={cn(
                  "flex items-center space-x-2 p-2 rounded-full group",
                  post.isLiked
              ...
              <Button
                ...
                size="sm"
                onClick={(e) =>
                  handleInteractionClick(e, () => onQuote(post.id))
                }
              ...
              <Button
                ...
                size="sm"
                onClick={(e) =>
                  handleInteractionClick(e, () => onShare(post.id))
                }
                className="flex items-center space-x-2 text-muted-foreground hover:text-primary hover:bg-primary/10 p-2 rounded-full group"
              >
