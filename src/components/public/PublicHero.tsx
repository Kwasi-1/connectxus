...
export const PublicHero: React.FC<PublicHeroProps> = ({ 
  ...
  return (
    <div className={`relative ${className}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex-1 max-w-xl mx-8">
              <h1 className="text-xl font-bold text-foreground custom-font truncate">
                {title}
              </h1>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link 
                to="/auth/signup" 
                className="inline-flex px-6 py-2 bg-foreground text-background rounded-full text-sm font-medium hover:bg-foreground/90 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                Join now
              </Link>
            </div>
      ...
      {/* Hero Content */}
      {showVisualElements && (
        <div className="relative bg-gradient-to-br from-background via-background to-accent/5 overflow-hidden">
          {/* Background Elements */}
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="text-center lg:text-left">
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-foreground mb-6 custom-font leading-tight">
                  {title}
                </h1>
                {subtitle && (
