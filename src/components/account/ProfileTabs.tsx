...
export const ProfileTabs = ({ user }: ProfileTabsProps) => {
  ...
  const getTabs = () => {
    const baseTabs = [
      ...
      { id: 'likes', label: 'Likes', icon: Heart, count: 0 },
    ];
    ...
    if (hasRole(authUser, 'mentor')) {
      baseTabs.push({ id: 'mentorship', label: 'Mentorship', icon: GraduationCap, count: 0 });
    }
      ...
      <TabsContent value="posts" className="space-y-4 mt-0">
        ...
        {user.posts.length > 0 ? (
          ...
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p className="text-sm">When you post something, it will show up here.</p>
          </div>
        )}
      </TabsContent>
