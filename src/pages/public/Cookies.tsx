        ...
        heroContent={
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
              This policy explains how Campus Connect uses cookies and similar
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-card border border-border/40 rounded-xl p-8 mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              keep you signed in, and understand how you use our platform to
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4">
              <p className="text-sm text-muted-foreground">
                ...
                Campus Connect only uses cookies that are necessary for our
                educational platform to function properly and to improve your
                academic networking experience.
              </p>
            </div>
          </div>

          <div className="mb-8">
            <h3 className="text-2xl font-bold text-foreground mb-8 text-center custom-font">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
                ...
                <p className="text-amber-700 dark:text-amber-300 text-sm">
                  ...
                  features of Campus Connect, including logging in and accessing
                  your account.
                </p>
              </div>
            </div>
          ...
          <div className="bg-card border border-border/40 rounded-xl p-8 mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Campus Connect may use trusted third-party services that also use
              cookies:
            </p>
            <div className="space-y-3 text-sm text-muted-foreground">
              <div className="flex items-start space-x-2">
                ...
                <span>
                  <strong>Analytics:</strong> To understand platform usage and
              ...
              <div className="flex items-start space-x-2">
                <span className="w-1.5 h-1.5 bg-primary rounded-full mt-2 flex-shrink-0"></span>
                <span>
                  <strong>Performance:</strong> To ensure fast loading and
          ...
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 border border-border/40 rounded-xl p-8">
            ...
            <p className="text-muted-foreground mb-4">
              We may update this Cookies Policy from time to time. We'll notify
              you of any material changes through the platform or via email.
            </p>
            <div className="space-y-2 text-sm text-muted-foreground">
              <p>
                Questions about cookies? Contact us at:
                privacy@campusconnect.edu
              </p>
              <p>
                Or visit our{" "}
