              ...
              {features.map((feature, index) => (
                <div key={index} className="group">
                  <div className="bg-background border border-border/20 rounded-2xl p-8 h-full transition-all duration-500 hover:border-primary/30 hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.02] cursor-pointer">
                    ...
                    <h3 className="text-xl font-semibold text-foreground mb-4 custom-font group-hover:text-primary transition-colors duration-300">{feature.title}</h3>
              ...
              {values.map((value, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-foreground mb-3 custom-font group-hover:text-primary transition-colors duration-300">{value.title}</h3>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {impactStats.map((stat, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">{stat.label}</h3>
                  <p className="text-sm text-muted-foreground group-hover:text-foreground transition-colors duration-300">{stat.description}</p>
