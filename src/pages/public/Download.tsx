  ...
  const platforms = [
    {
      ...
      title: "Mobile Apps",
      description:
        "Stay connected on the go with our native mobile applications.",
      features: [
        "Push notifications",
        "Offline reading",
        "Camera integration",
    ...
    },
    {
      ...
      title: "Desktop Apps",
      description:
        "Get the full experience with dedicated desktop applications.",
      features: [
  ...
  const features = [
    {
      ...
      description:
        "Never miss important updates from your university community",
    },
    {
      icon: DownloadIcon,
      title: "Offline Access",
      description:
        "Read saved posts and messages even without internet connection",
    },
    {
      icon: Smartphone,
        ...
        heroContent={
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Download Campus Connect for the best experience on all your
              devices. Available on mobile and desktop platforms.
            </p>
      ...
      <main className="flex-1 bg-gradient-to-t from-background via-background to-accent/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Scan the QR code with your phone's camera to quickly download
                  the mobile app.
                </p>
                <p className="text-sm text-muted-foreground">
                  Compatible with iOS and Android devices. The QR code will
                  automatically detect your device type.
                </p>
              </div>
          ...
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-foreground mb-8 custom-font">
