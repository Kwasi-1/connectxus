  ...
  return (
    <AppLayout showRightSidebar={false}>
      <div className="p-6 custom-fonts">
        <div className='relative lg:sticky lg:top-6 bg-background z-40'>
        {/* Header */}
        <div className="flex justify-between items-start sm:items-center gap-4 pb-6">
          <div>
        ...
        {/* Search and Filters */}
        <div className="space-y-4 sticky lg:top-28 top-16 bg-background z-40 -mt-2 pt-2 pb-4">
